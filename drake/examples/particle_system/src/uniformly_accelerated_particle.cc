...
#include "drake/examples/particle_system/src/degenerate_euler_joint.hh"
...
DEFINE_double(initial_acceleration, 1.0, "Particle constant x acceleration");
...
namespace drake {
  namespace particles {
	...
	FLAGS_initial_acceleration, interface);
