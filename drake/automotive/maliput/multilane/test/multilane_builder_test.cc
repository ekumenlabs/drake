...
GTEST_TEST(MultilaneBuilderTest, Fig8) {
  ...
  auto c2 = b.Connect("2", 1, 0., kLeftShoulder, kRightShoulder,
                      c1->end(), kCounterClockwiseArc, kMidFlatZ);

  auto c3 = b.Connect("3", 1, 0., kLeftShoulder, kRightShoulder, c2->end(),
                      50., kHighFlatZ);
  auto c4 = b.Connect("4", 1, 0., kLeftShoulder, kRightShoulder, c3->end(),
                      50., kMidFlatZ);
...
GTEST_TEST(MultilaneBuilderTest, QuadRing) {
  ...
  // This heads -y, loops to +x, counterclockwise, back to origin.
  auto right1 = b.Connect("right1", 1, 0., kLeftShoulder, kRightShoulder,
                          northbound.reverse(), kLargeCounterClockwiseLoop,
                          kFlatZ);
  ...
  b.SetDefaultBranch(
      left1, 0, api::LaneEnd::kStart, left1, 0, api::LaneEnd::kFinish);
  b.SetDefaultBranch(
      left0, 0, api::LaneEnd::kFinish, right0, 0, api::LaneEnd::kStart);
  b.SetDefaultBranch(
      right0, 0, api::LaneEnd::kFinish, right1, 0, api::LaneEnd::kFinish);
  b.SetDefaultBranch(
      right1, 0, api::LaneEnd::kStart, left1, 0, api::LaneEnd::kFinish);

  b.SetDefaultBranch(
      left1, 0, api::LaneEnd::kFinish, left1, 0, api::LaneEnd::kStart);
  b.SetDefaultBranch(
      left0, 0, api::LaneEnd::kStart, right1, 0, api::LaneEnd::kStart);
  b.SetDefaultBranch(
      right0, 0, api::LaneEnd::kStart, right1, 0, api::LaneEnd::kStart);
