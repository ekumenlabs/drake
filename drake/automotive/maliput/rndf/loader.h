...
/// @file
/// Loader for serialized rndf road networks.
///
...
/// Loads the input string as a maliput_rndf_builder document.
std::unique_ptr<const api::RoadGeometry> Load(const std::string& input);

/// Loads the named file as a maliput_rndf_builder document.
